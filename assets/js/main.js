...
async function setupImgs() {
  ...
  document.getElementById('show-all').onclick = () => {
    ...
    document.getElementById('demand-shifter').style.bottom = '-17em';
  };

  document.getElementById('hide-notice').onclick = () => document.getElementById('demand-shifter').style.bottom = '-17em';
}
